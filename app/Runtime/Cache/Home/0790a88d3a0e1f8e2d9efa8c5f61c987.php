...
<div class="content">
  ...
  <!--列表 BEGIN-->
  <div class="list">
      <form action="<?php echo U('Home/NewsTpl/del');?>" method="post" class="del-form">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a href="<?php echo U('Home/NewsTpl/info',array('id'=>$vo[id]));?>" class="mr10">编辑</a>
                    <a href="<?php echo U('Home/NewsTpl/del',array('id'=>$vo[id]));?>">删除</a>
                </td>
