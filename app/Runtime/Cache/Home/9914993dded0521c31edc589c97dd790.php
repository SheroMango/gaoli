...
<div class="content">
  ...
  <div class="tabs">
    <ul>
      <li class="current"><a href="javascript:void(0)" class="current">幻灯片列表</a></li>
    </ul>
  </div>
  <!--END 选项卡-->
  ...
  <!--工具栏 BEGIN-->
  <div class="toolbar">
      <a href="<?php echo U('Home/PowerPoint/info');?>" class="btn"><span>添加幻灯片</span></a>
  </div>
  <!--END工具栏 BEGIN-->
  
  <!--列表 BEGIN-->
  <div class="list">
      <form action="<?php echo U('Home/PowerPoint/del');?>" method="post" class="del-form">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <?php if(empty($list)): ?><tr>
              <td colspan="11" class="empty">暂无幻灯片</td>
            </tr>
          <?php else: ?>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>             <a href="<?php echo U('Home/PowerPoint/info',array('id'=>$vo[id]));?>" class="mr10">编辑</a>
                    <a href="<?php echo U('Home/PowerPoint/del',array('id'=>$vo[id]));?>">删除</a>
                </td>
