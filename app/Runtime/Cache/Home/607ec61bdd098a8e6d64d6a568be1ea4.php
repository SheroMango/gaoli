...
<div class="tabs">
    <ul>
        <li class="current"><a href="javascript:void(0)" class="current">文本回复</a></li>
    </ul>
</div>
<div class="edit">
    <form method="post" action="<?php echo U('Home/Text/doEdit');?>" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
        <input type="hidden" name="route_id" value="<?php echo ($routeInfo["id"]); ?>">
        <dl>
            <dt>关键字：</dt>
            <dd><input type="text" name="keyword" class="w200" value="<?php echo ($routeInfo["keyword"]); ?>" /></dd>
        </dl>
        <dl>
            <dt>回复内容：</dt>
