...
<div class="tabs">
    <ul>
        <li class="current"><a href="javascript:void(0)" class="current">幻灯片类别</a></li>
    </ul>
</div>
<div class="edit">
    <form method="post" action="<?php echo U('Home/PPType/info');?>" enctype="multipart/form-data">
        ...
        <dl>
            <dt>标志：</dt>
            <dd><input type="text" name="flag" value="<?php echo ($info["flag"]); ?>" class="w200" /></dd>
        </dl>
        <dl>
            <dt>排序：</dt>
