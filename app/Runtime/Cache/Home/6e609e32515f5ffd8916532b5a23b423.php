...
<div class="edit">
    <form method="post" action="<?php echo U('Home/Keyword/info');?>" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
        <input type="hidden" name="pid" value="<?php echo ($pid); ?>">
        <dl>
            <dt>关键字：</dt>
            <dd><input type="text" name="content" value="<?php echo ($info["content"]); ?>" class="w200" /></dd>
        </dl>
        <dl>
            <dt>回复内容：</dt>
            <dd><textarea name="replay" cols="80" rows="4"><?php echo ($info["replay"]); ?></textarea></dd>
        </dl>
        <dl>
            <dt></dt>
