...
<div class="content">
  ...
  <!--工具栏 BEGIN-->
  <div class="toolbar">
      <a href="<?php echo U('Home/Message/info');?>" class="btn"><span>添加分类</span></a>
  </div>
  <!--END工具栏 BEGIN-->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <?php if(empty($list)): ?><tr>
              <td colspan="11" class="empty">暂无相关分类信息</td>
            </tr>
          <?php else: ?>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a href="<?php echo U('Home/MessageType/info',array('id'=>$vo[id]));?>" class="mr10">编辑</a>
                    <a href="<?php echo U('Home/MessageType/del',array('id'=>$vo[id]));?>">删除</a>
                </td>
