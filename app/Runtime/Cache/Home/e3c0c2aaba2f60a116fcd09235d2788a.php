...
<div class="content">
  ...
  <!--工具栏 BEGIN-->
  <div class="toolbar">
      <a href="<?php echo U('Home/Article/info', array('pid'=>$pid));?>" class="btn"><span>添加文章</span></a>
  </div>
  <!--END工具栏 BEGIN-->

   <!--搜索 BEGIN-->
<div class="search">
    <form action="<?php echo U('Home/Article/ls');?>" method="post">
        <table width="100%">
            <td width="100">
...
<!--END 搜索--> 
  ...
  <!--列表 BEGIN-->
  <div class="list">
      <form action="<?php echo U('Home/Article/del');?>" method="post" class="del-form">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            <th width="5%"><input type="checkbox" class="check-all" /></th>
            <th width="20%"><a href="<?php echo U('Home/Article/ls',array('sort'=>'title','type'=>$type));?>">标题</th>
            <th width="20%"><a href="<?php echo U('Home/Article/ls',array('sort'=>'intro','type'=>$type));?>">描述</th>
            <th width="20%"><a href="<?php echo U('Home/Article/ls',array('sort'=>'sort','type'=>$type));?>">排序</th>
            <th width="20%"><a href="<?php echo U('Home/Article/ls',array('sort'=>'time_add','type'=>$type));?>">更新时间</th>
            <th width="15%">操作</th>
          </tr>
        </thead>
        <tbody>
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a href="<?php echo U('Home/Article/ls',array('pid'=>$vo[id]));?>" class="mr10">子文章</a>
