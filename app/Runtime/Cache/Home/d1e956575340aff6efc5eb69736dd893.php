...
<div class="tabs">
    <ul>
        <li class="current"><a href="javascript:void(0)" class="current">关键字</a></li>
    </ul>
</div>
<div class="edit">
    <form method="post" action="<?php echo U('Home/Txp/doAdd');?>" enctype="multipart/form-data">
        <input type="hidden" name="fid" value="<?php echo ($fid); ?>">
            <dl>
            <dt>关键字：</dt>
            <dd><input type="text" name="keyword" class="w200" /></dd>
        </dl>
        <dl>
            <dt>标题：</dt>
            <dd><input type="text" name="title" class="w200" /></dd>
        </dl>
        <dl>
            <dt>描述：</dt>
            <dd><input type="text" name="description" class="w200" /></dd>
        </dl>
        <dl>
            <dt>图片</dt>
        ...
        <dl>
            <dt>回复内容：</dt>
            <dd><textarea name="content" cols="80" rows="4"></textarea></dd>
        </dl>
        <dl>
            <dt></dt>
