...
<div class="content">
  ...
  <!--工具栏 BEGIN-->
  <div class="toolbar">
      <a href="<?php echo U('Home/KeyPt/info');?>" class="btn"><span>添加关键字</span></a>
  </div>
  <!--END工具栏 BEGIN-->

   <!--搜索 BEGIN-->
<div class="search">
    <form action="<?php echo U('Home/KeyPt/ls');?>" method="post">
        <table width="100%">
            <td width="100">
...
<!--END 搜索--> 
  ...
  <!--列表 BEGIN-->
  <div class="list">
      <form action="<?php echo U('Home/KeyPt/del');?>" method="post" class="del-form">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a href="<?php echo U('Home/KeyPt/info',array('id'=>$vo[id]));?>" class="mr10">编辑</a>
                    <a href="<?php echo U('Home/KeyPt/del',array('id'=>$vo[id]));?>">删除</a>
                </td>
